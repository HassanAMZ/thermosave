      ...
      <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 16 }}>
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ md: 'row' }}>
              <Stack align="center" justify="space-around" direction={{ base: 'row' }}>
                ...
                <Link target="_blank" href="https://www.linkedin.com/in/irfan-nasir-16aa5bb6/">
                  <IconButton
                    color={useColorModeValue('gray.300', 'gray.800')}
                    aria-label="linkedin"
                    variant="ghost"
                ...
                <Link target="_blank" href="https://wa.me/923340250893">
                  <IconButton
                    color={useColorModeValue('gray.300', 'gray.800')}
                    aria-label="linkedin"
                    variant="ghost"
